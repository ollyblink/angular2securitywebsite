...
describe('DataComponent', ()=> {
  ...
  it('#deleteDataItem: should delete data item with title "test data 1"', fakeAsync(()=> {
    ...
    expect(fixture.debugElement.query(By.css('#message')).nativeElement.textContent).toBe('test data 2', 'message should be title of item to delete');

    tick();
    fixture.detectChanges();
    expect(fixture.debugElement.query(By.css('#message')).nativeElement.textContent).toBe(testMessage, 'message should be message returned from server');
  ...
  it('#addDataItem: should add a new data item', fakeAsync(()=> {
    ...
    expect(fixture.debugElement.query(By.css('#message')).nativeElement.textContent).toBe(testMessage, 'server message');
  }));
});
