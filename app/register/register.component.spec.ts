...
describe('RegisterComponent', ()=> {
  ...
  it('should call register and display a response message', fakeAsync(inject([Router], (router: Router)=> {
    ...
    expect(fixture.debugElement.query(By.css('.message')).nativeElement.textContent).toBe(RegisterComponent.WAITING_TEXT, 'Waiting message');
    ...
    expect(fixture.debugElement.query(By.css('.message')).nativeElement.textContent).toBe('Successfully created user with username o1', 'registered successfully');
